...
EntryPoint:  
	...
	move.l #$00000000, a0 ; Starting from address 0x0, clearing backward
	move.l #$00003FFF, d1 ; Clearing 64k's worth of longword (minus 1, for the loop to be correct)
	@Clear:
	...
	; The Trade Mark Security Signature – or TMSS
	...
	; Initialsing the VDP, aka GPU
	lea VDPRegisters, a0
	move.l #VDPRegistersSize, d0
	jsr VDP_Init
	...
	; Init status register ( no trace, A7 is Interrupt Stack Pointer, no interrupts, claer condition code bits)
	move #$2000, sr
...
Z80DataSize       equ (EndZ80Data-Z80Data)
VDPRegistersSize  equ (EndVDPRegisters-VDPRegisters) 
...
VDPRegisters:
	...
	dc.b forReg1 ; 1: Vert. interrupt on, display on, DMA on, V30 mode (30 cells vertically), + bit 2
	dc.b 0x30 ; 2: Pattern table for Scroll Plane A at 0xC000 (bits 3-5)
	dc.b 0x28 ; 3: Pattern table for Window Plane at 0xA000 (bits 1-5)
	dc.b 0x07 ; 4: Pattern table for Scroll Plane B at 0xE000 (bits 0-2)
	dc.b 0x5C ; 5: Sprite table at 0xB800 (bits 0-6)
	dc.b 0x00 ; 6: Unused
